...
const config = createConfig({
  ...
  appearance: {
    ...
    theme: {
      "--pcm-primary-button-color": "#ffffff", // Black text on buttons (to contrast bright background)
      "--pcm-primary-button-bankground": "#9333EA", // Purple background for primary buttons
      "--pcm-primary-button-hover-background": "#9333EA", // Slightly darker purple on hover
    },
  },
  walletConnectors: [
    evmWalletConnectors({
